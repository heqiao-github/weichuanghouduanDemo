...
class Role extends Component {
  ...
  showAuth = (user) => {
    debugger
    const role = this.roles.find(item=>item.__id=== user.roleId);
  ...
  render() {
    ...
    const title = (
      ...
      <Button type="primary" disabled={ false} onClick={this.showAuth(role)}>设置角色权限</Button>
      </>
    )
    const columns = [
      {
      ...
      <Card title={title}>
        ...
        >
          ...
          >
            ...
            <RoleTree ref={this.treeRef} menus={this.menus}/>
          </Modal>
      </Card>
    )
  }
