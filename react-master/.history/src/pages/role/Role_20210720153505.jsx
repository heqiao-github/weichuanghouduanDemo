...
console.log(config1,4444444444444444);
...
class Role extends Component {
  ...
  render() {
    ...
    const title = (
      ...
      <Button type="primary" disabled={ true} onClick={this.showAuth}>设置角色权限</Button>
      </>
    )
    const columns = [
      {
      ...
      <Card title={title}>
        ...
        >
          ...
          <Modal
            ...
            cancelText="取消"
          >
            <Item label="角色名称dd" {...layout} >
              <Input type="text" value={role.name} disabled/>  
            </Item>
            <Item label="角色名称2ddd" {...layout}>
            <Input type="text" value={role.name} disabled/>  
            </Item>
